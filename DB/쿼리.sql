...
('hero423', 'hero423@mail.com' ,'hashed_password4'),
('hero523', 'hero523@mail.com' ,'hashed_password5'),
('hero623', 'hero623@mail.com' ,'hashed_password6'),
('hero723', 'hero723@mail.com' ,'hashed_password7')
...
-- 5. 특정 플레이어 정보 업데이트
UPDATE palyers SET last_login = CURRENT_TIMESTAMP WHERE username = 'hero123'
